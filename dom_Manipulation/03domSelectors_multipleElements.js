...
- Multiple Elements Selectors
    - will allow you to grab all elemetns with the same class and return an HTML collection or a node-list, depending on which selector you use
...
// document.getElemetnsByTagName

// let lis = document.getElementsByTagName('li');

// // console.log(lis);
// lis[0].style.color = 'blue';
// lis[3].textContent = 'Tag Name';
...
// // pass an index and se it to a template string
